...
void print_seal(int row, int col) {
  ...
  mvprintw(row/2-14, col/2-22, "%s", mesg);
  strcpy(mesg, "U     -':'             -::*=UUUUUU':       U");
  mvprintw(row/2-13, col/2-22, "%s", mesg);
  strcpy(mesg, "U     -'--':           +UUUUUU'UUUUU-      U");
  mvprintw(row/2-12, col/2-22, "%s", mesg);
  strcpy(mesg, "U     ::--'-        ''''.-:=UUUUUUUU       U");
  mvprintw(row/2-11, col/2-22, "%s", mesg);
  strcpy(mesg, "U     -'-:'           :''':+UUUUUUUU-      U");
  mvprintw(row/2-10, col/2-22, "%s", mesg);
  strcpy(mesg, "U     -':''             'UUUUUUUUUU:       U");
  mvprintw(row/2-9, col/2-22, "%s", mesg);
  strcpy(mesg, "U      =-'=             -'UUUUUUUUU+       U");
  mvprintw(row/2-8, col/2-22, "%s", mesg);
  strcpy(mesg, "U      -:'U'          :UUUUUUUUUUUU'       U");
  mvprintw(row/2-7, col/2-22, "%s", mesg);
  strcpy(mesg, "U     -'UUUUUUU=**+::'UUUUUUUUUUUUU+       U");
  mvprintw(row/2-6, col/2-22, "%s", mesg);
  strcpy(mesg, "U      =UUU+=UUUUUUUUUUUUUUUUUUUUUU:       U");
  mvprintw(row/2-5, col/2-22, "%s", mesg);
  strcpy(mesg, "U       =UUU''=UUUUUUUUUUUUUUUUUUUU        U");
  mvprintw(row/2-4, col/2-22, "%s", mesg);
  strcpy(mesg, "U       ::=UUUUUUUUUUUUUUUUUUUUUUU*        U");
  mvprintw(row/2-3, col/2-22, "%s", mesg);
  strcpy(mesg, "U              +++**=UUUUUUUUUUUUU=        U");
  mvprintw(row/2-2, col/2-22, "%s", mesg);
  strcpy(mesg, "UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU");
  mvprintw(row/2-1, col/2-22, "%s", mesg);
  strcpy(mesg, "U-    UUUUUUUUUUUUU      UUUUUUUUUUUUU    -U");
  mvprintw(row/2, col/2-22, "%s", mesg);
...
void print_bar_chart(int row, int col, int valid, int total, time_t timestamp)
{
  ...
  int i, j;
  strcpy(mesg, "^");
  mvprintw(row/2-10, col/2-28, "%s", mesg);
  strcpy(mesg, "\% valid |");
  mvprintw(row/2-9, col/2-36, "%s", mesg);
  strcpy(mesg, "updates |");
  mvprintw(row/2-8, col/2-36, "%s", mesg);
  strcpy(mesg, "|");
  for(i=-7; i<1; i++) {
    mvprintw(row/2+i, col/2-28, "%s", mesg);
  }
  strcpy(mesg, "|=====|=====|=====|=====|=====|=====|=====|=====|=====>");
  mvprintw(row/2+1, col/2-28, "%s", mesg);
  strcpy(mesg, "10    20    30    40    50    60    70    80    time (min)");
  mvprintw(row/2+2, col/2-23, "%s", mesg);
